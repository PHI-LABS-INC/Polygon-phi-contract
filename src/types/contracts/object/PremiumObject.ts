...
export interface PremiumObjectInterface extends utils.Interface {
  ...
  events: {
    ...
    "CreatePremiumObject(uint256,string,tuple,address,uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "CreatePremiumObject"): EventFragment;
...
export interface CreatePremiumObjectEventObject {
  tokenId: BigNumber;
  uri: string;
  size: BaseObject.SizeStructOutput;
  creator: string;
...
export type CreatePremiumObjectEvent = TypedEvent<
  [
    BigNumber,
    string,
    BaseObject.SizeStructOutput,
  ...
  CreatePremiumObjectEventObject
>;

export type CreatePremiumObjectEventFilter =
  TypedEventFilter<CreatePremiumObjectEvent>;
...
export interface PremiumObject extends BaseContract {
  ...
  filters: {
    ...
    "CreatePremiumObject(uint256,string,tuple,address,uint256,uint256)"(
      tokenId?: null,
      uri?: null,
      size?: null,
      creator?: null,
