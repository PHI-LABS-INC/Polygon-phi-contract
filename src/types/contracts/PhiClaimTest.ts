...
export declare namespace PhiClaimTest {
...
export interface PhiClaimTestInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [string, BigNumberish, string, PhiClaimTest.CouponStruct]
  ): string;
  encodeFunctionData(
...
export interface PhiClaimTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PhiClaimTestInterface;
  ...
  functions: {
    ...
    claimQuestObject(
      ...
      tokenId: BigNumberish,
      condition: string,
      coupon: PhiClaimTest.CouponStruct,
