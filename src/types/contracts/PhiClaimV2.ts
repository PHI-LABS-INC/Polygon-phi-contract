...
export declare namespace PhiClaimV2 {
...
export interface PhiClaimV2Interface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [string, BigNumberish, string, PhiClaimV2.CouponStruct]
  ): string;
  encodeFunctionData(
...
export interface PhiClaimV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PhiClaimV2Interface;
  ...
  functions: {
    ...
    claimQuestObject(
      ...
      tokenId: BigNumberish,
      condition: string,
      coupon: PhiClaimV2.CouponStruct,
